...
void instruction()
{
    printf("*********************** INSTRUCTION ***********************\n ");
    printf("\n");
    printf("Symbol for Player 1 :: 0 \n");
    printf("\n");
    printf("Symbol for Player 2 :: x \n");
    printf("\n");
}
...
int main()
{
    ...
    while (1)
    {
        ...
        if (flag == 1)
        {
            printf("Enter the number b/w (1 to 9) for PLayer 1 : ");
        }
        else
        {
            printf("Enter the number b/w (1 to 9) for Player 2 : ");
        }
        scanf("%d", &pos);
        if (pos >= 1 && pos <= 9)
        {
